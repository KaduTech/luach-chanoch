...
- Today, conversion, year/month views, daily readings, approved feast observances, onboarding, dark mode, and local private journal features are implemented.
...
3. The privacy policy and support pages are published at `https://www.kadutech.com/luach-chanoch/privacy` and `https://www.kadutech.com/luach-chanoch/support`; enter these URLs in the store records.
